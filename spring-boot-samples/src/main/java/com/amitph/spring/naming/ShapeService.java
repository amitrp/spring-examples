...
public class ShapeService {
    ...
    @Autowired private Shape circle;

    @Autowired private Shape rectangle;

    @Autowired private Shape squareType;

    @Autowired private Shape triangleShape;

    @Autowired private Shape pentagonShape;
